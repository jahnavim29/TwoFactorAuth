...
import com.sams.email.samsemail.utils.ValidationUtils;
...
public class EmailExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<ExceptionResponse> handleSMSSException(Exception ex, WebRequest request) {
